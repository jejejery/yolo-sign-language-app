...
object YOLOUtils {
    ...
    fun loadModelFile(context: Context, modelPath: String): java.nio.MappedByteBuffer {
        ...
        // logAssets(context) // Log all assets for debugging
...
//     try {
//         // Dapatkan daftar file dan folder di dalam path yang diberikan (default ke root assets jika path kosong)
//         val assetFiles = assetManager.list(path) // Get list of files in the folder
...
//                 try {
//                     // Cek apakah subPath adalah folder
//                     val subFiles = assetManager.list(fullPath)
//                     if (subFiles != null && subFiles.isNotEmpty()) {
//                         // Jika folder ditemukan, lakukan rekursi
//                         files.addAll(listAssets(context, fullPath))
//                     } else {
//                         // Jika file ditemukan, tambahkan ke list
//                         files.add(fullPath)
//                     }
//                 } catch (e: Exception) {
//                     // Jika file atau folder tidak bisa diakses (harusnya file), tambahkan ke list
//                     files.add(fullPath)
//                 }
//             }
//         }
//     } catch (e: IOException) {
//         Log.e(TAG, "Error accessing assets at $path: ${e.message}")
//     }
//     return files
// }

// private fun logAssets (context : Context) {
//     var files = listAssets(context, "")
//     Log.d(TAG, "Assets in the app:")
//     for (file in files) {
//         Log.d(TAG, "Asset: $file")
//     }
//     files = listAssets(context, "/flutter_assets")
//     Log.d(TAG, "Assets in the /flutter_assets:")
//     for (file in files) {
//         Log.d(TAG, "Asset: $file")
//     }
// }    
